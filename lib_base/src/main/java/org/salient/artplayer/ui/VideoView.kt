...
open class VideoView : FrameLayout, IVideoView {
    ...
    override fun seekTo(time: Long) {
        Logs.d(TAG, "seekTo() called with: time = $time")
        when (playerState) {
    ...
    override fun setVolume(volume: Int) {
        Logs.d(TAG, "setVolume() called with: volume = $volume")
        audioManager.setVolume(volume)
    }

    override fun attach() {
        Logs.d(TAG, "attach() called")
        surfaceTexture?.let {
            surface?.release()
            surface = Surface(it)
    ...
    override fun onSurfaceTextureAvailable(surfaceTexture: SurfaceTexture, width: Int, height: Int) {
        Logs.d(TAG, "onSurfaceTextureAvailable() called with: surfaceTexture = $surfaceTexture, width = $width, height = $height")
    ...
    override fun onSurfaceTextureSizeChanged(surfaceTexture: SurfaceTexture, width: Int, height: Int) {
        Logs.d(TAG, "onSurfaceTextureSizeChanged() called with: surfaceTexture = $surfaceTexture, width = $width, height = $height")
    ...
    override fun onSurfaceTextureDestroyed(surfaceTexture: SurfaceTexture): Boolean {
        Logs.d(TAG, "onSurfaceTextureDestroyed() called with: surfaceTexture = $surfaceTexture")
    ...
    private val videoSizeObserver = Observer<VideoSize> {
        Logs.d(TAG, "VideoSize: width = ${it.width}, height = ${it.height}")
    ...
    private val playerStateObserver = Observer<PlayerState> {
        Logs.d(TAG, "PlayerState: ${it.javaClass.canonicalName}")
        when (it) {
