...
fun String.base64EncodeToString(flag: Int = Base64.DEFAULT): String =
    Base64.encodeToString(toByteArray(), flag)

fun String.base64Decode(flag: Int = Base64.DEFAULT): ByteArray =
    Base64.decode(this, flag)

fun String.base64DecodeString(flag: Int = Base64.DEFAULT): String =
    String(Base64.decode(this, flag))
